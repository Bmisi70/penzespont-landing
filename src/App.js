      ...
      <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-24">
              ...
              {statistics.map((_, idx) => (
                <div 
                  ...
                  className={`h-2 rounded-full transition-all ${
                    idx === currentStat ? 'w-8 bg-orange-400' : 'w-2 bg-white/30'
                  }`}
                ></div>
              ))}
            </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className={`text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            Az elso magyar penzugyi kepzes, ami <strong className="text-orange-400">tenylegertheto</strong> es <strong className="text-orange-400">szorakoztato</strong>. 
            Tanulj befektetest, koltsegvetest es vagyonepites olyan peldakkal, amiket <strong className="text-white">mindenki megert</strong>.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {[
              ...
              "Nem erted a szakzsargont (P/E rata, diverzifikacio...)",
          ...
          <div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 border-2 border-green-500/30 rounded-2xl p-8 text-center backdrop-blur-md">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              A PenzEsPont <strong className="text-green-400">egyszeruve es szorakoztatova</strong> teszi 
              a penzugyi tanulast. Ha erted a kosarlabdat, <strong className="text-green-400">erteni fogod a penzugyeket is</strong>.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 text-lg">
              ...
              <strong className="text-orange-400"> Portfolio = Csapat</strong>, 
              <strong className="text-orange-400"> Diverzifikacio = Minden posztra jatekos</strong>.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300 text-lg">
              Ne csak olvasd - <strong className="text-blue-400">csinald</strong>! 
              Szimulációk, kalkulátorok, döntési játékok. Tanulj játék közben.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300 text-lg">
              Nem elmelet - <strong className="text-green-400">valos eszkozok</strong>. 
              Koltsegvetes, befektetes, adossagkezeles. Hasznalhato tudas.
            </p>
          </div>
        </div>
      </div>
